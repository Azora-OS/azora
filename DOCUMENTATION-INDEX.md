...
- **New Developer?** → [QUICK-START-GUIDE.md](QUICK-START-GUIDE.md)
- **Deploying?** → [PRODUCTION-DEPLOYMENT.md](PRODUCTION-DEPLOYMENT.md)
- **Implementation Tasks?** → [MASTER-IMPLEMENTATION-PLAN.md](MASTER-IMPLEMENTATION-PLAN.md)
- **Agent Tasks?** → [docs/MASTER-TASKLIST-FOR-AGENTS.md](docs/MASTER-TASKLIST-FOR-AGENTS.md)
- **Using API?** → [API-SPECIFICATIONS.md](API-SPECIFICATIONS.md)
...
- [Launch Checklist](docs/LAUNCH-CHECKLIST.md) - Production readiness
...
**Status**: Active development - see docs/MASTER-TASKLIST-FOR-AGENTS.md for current priorities
