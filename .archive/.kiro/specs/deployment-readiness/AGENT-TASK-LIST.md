...
**IMPORTANT**: This high-level agent task list has a companion, more prioritized & reviewed `docs/MASTER-TASKLIST-FOR-AGENTS.md` in the `docs/` folder. Agents should consult that file first for CRITICAL tasks.
---
