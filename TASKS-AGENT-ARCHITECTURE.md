...
1. Agent Execution Framework (P0)
  ...
  - Task A2: Implement persistence (Prisma) + migrations (in-progress: schema and runtime wiring added for Task and Execution models)
  - Task A3: Add agent lifecycle operations (pause/resume/cancel)
    - Task A3: Add agent lifecycle operations (pause/resume/cancel) (partial: runtime implements best-effort pause/resume/cancel with DB execution updates)
