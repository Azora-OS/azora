            ...
            <div className="flex flex-col gap-6">
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground sm:text-xl text-pretty max-w-lg">
                  Discover qualifications from around the world, earn blockchain-verified credentials, and get rewarded
                  with AZR tokens for your achievements.
                </p>
              </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {categories.map((category) => (
              <Link
                ...
                className="group rounded-lg border border-border bg-card p-6 hover:border-blue-500 hover:bg-blue-500/5 transition-all"
              >
          ...
          <div className="grid gap-8 md:grid-cols-4 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold text-foreground">Azora Sapiens</span>
              </div>
              <p className="text-sm text-muted-foreground">
                Empowering global education with blockchain verification and crypto rewards
              </p>
            </div>
            <div>
