...
// import AxeBuilder from '@axe-core/playwright'; // Dynamically imported
  ...
  private async initBrowser(): Promise<Browser> {
    if (!this.browser) {
      try {
        ...
        throw new Error('Playwright is not installed. Verification features require @playwright/test.');
      }
    }
    return this.browser;
  }
