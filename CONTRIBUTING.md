...
The Azora project adheres to Ubuntu philosophy: "I can because we can." We expect all contributors to:
...
**Azora OS Language Standardization Strategy**

Our codebase contains both TypeScript and JavaScript services. To ensure consistency and maintainability:

#### Current State Analysis
- **TypeScript Services**: 43 services with modern type safety
- **JavaScript Services**: 49 services (primarily legacy or simple services)
- **Mixed Services**: Some services have both TS and JS files

#### Standardization Rules

1. **New Services**: Must be written in TypeScript
2. **Critical Services**: Must be migrated to TypeScript (auth, api-gateway, payments, marketplace)
3. **Simple Services**: May remain in JavaScript if they meet criteria:
   - < 500 lines of code
   - No complex business logic
   - No external API integrations
   - Stable and rarely modified

#### Migration Priority

**High Priority (Migrate within 1 month):**
- `azora-auth` - Security critical
- `azora-api-gateway` - Core routing
- `azora-pay` - Financial operations
- `azora-marketplace` - Business logic

**Medium Priority (Migrate within 3 months):**
- Constitutional AI services
- Educational services
- Communication services

**Low Priority (Keep as JS):**
- Simple health check services
- Utility services
