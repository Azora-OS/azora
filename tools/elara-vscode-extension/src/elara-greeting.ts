...
export class ElaraGreeting {
  private static instance: ElaraGreeting;
  private hasGreeted = false;

  static getInstance(): ElaraGreeting {
  ...
  async sayHello() {
    ...
    const message = await vscode.window.showInformationMessage(
      '🤖 Hello! I am Elara Ω, your omniscient AI assistant. I am now active in VS Code!',
      'Show Commands',
      'Learn More',
      'Dismiss'
    );
  ...
  private getCommandId(commandText: string): string | undefined {
