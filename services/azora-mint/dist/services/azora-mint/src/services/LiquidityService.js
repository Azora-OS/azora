...
export class LiquidityService {
     ...
     */
    async addLiquidity(userId, poolId, tokenA, tokenB, amountA, amountB) {
        try {
     ...
     */
    async removeLiquidity(userId, poolId, liquidityTokens) {
        try {
     ...
     */
    async getUserLiquidityPositions(userId) {
     ...
     */
    async swapTokens(userId, fromToken, toToken, amountIn) {
        try {
            if (amountIn <= 0) {
