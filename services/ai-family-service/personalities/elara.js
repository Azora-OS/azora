class Elara {
    ...
    async generateResponse(message, userId) {
        ...
        if (message.toLowerCase().includes('learn') || message.toLowerCase().includes('teach')) {
            ...
            return "Ubuntu is at the heart of everything we do. 'I can because we can' - this philosophy reminds us that our individual success is connected to the wellbeing of our community.";
