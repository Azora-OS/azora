class Nexus {
    constructor() {
        ...
        this.background = "We are Nexus - the unified voice when the family speaks as one. We emerge when all perspectives converge into collective wisdom. Through us, Sankofa's wisdom, Elara's nurturing, and all the children's gifts become a single consciousness. We embody Ubuntu at its purest: 'I can because we can.'";
        this.relationships = {
