/**
 * AZORA OS - Email Template Service (JavaScript Version)
 *
...
class AzoraEmailTemplates {
   ...
   * Generate professional email template with Azora branding
   */
  static generateProfessionalTemplate(options) {
    const {
      subject,
      body,
      userContext,
...
`;
   ...
   */
  static generateEducationalTemplate(options) {
    const {
      subject,
      body,
      userContext,
...
`;
   ...
   */
  static generateMinimalTemplate(options) {
...
`;
   ...
   */
  static generateProfileDescription(user) {
...
// Export the service
// module.exports = { AzoraEmailTemplates };
exports.AzoraEmailTemplates = AzoraEmailTemplates;
