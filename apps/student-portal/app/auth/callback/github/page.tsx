          ...
          <div className="flex items-center justify-center">
            {status === 'loading' && (
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-600">Processing your GitHub sign-in...</span>
              </div>
            )}
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <p>Your GitHub account is securely connected to Azora OS for enhanced coding education and collaborative development.</p>
              </div>
            </div>
          </div>
        </div>
