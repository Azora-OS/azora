...
function PremiumFeatureCard({ feature, onClick }: PremiumFeatureCardProps) {
    return (
        <div
            className={`
...
export function PremiumUnlockModal({ feature, onClose }: PremiumUnlockModalProps) {
    return (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 max-w-md w-full border-2 border-yellow-500/50 relative">
                <button
                    onClick={onClose}
