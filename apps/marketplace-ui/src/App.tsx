...
import { useMarketplaceApi } from '../../../packages/hooks/useApi'
...
function App() {
  ...
  // Fetch marketplace data using the new API hook with fallback to mock data
  const { data: marketplaceData, isLoading, error, refetch } = useMarketplaceApi('/dashboard')
      ...
      case 'dashboard':
        return (
          <Suspense fallback={<LoadingFallback />}>
            <Dashboard data={marketplaceData?.data} />
          </Suspense>
        )
      case 'alerts':
        return (
...
// Wrap with ThemeProvider at main.tsx level instead
