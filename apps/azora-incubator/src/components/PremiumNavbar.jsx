                ...
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            {subtitle && (
                                <span className="hidden md:inline-block ml-2 text-xs text-indigo-200 border-l border-white/20 pl-2">
                                    {subtitle}
                                </span>
                            )}
                        </div>
                    ...
                    <div className="hidden md:flex items-center gap-1">
                        {menuItems.map((item) => (
                            <a
                                key={item.label}
                                href={item.href}
                                className="px-4 py-2 text-sm text-indigo-100 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                            >
                                {item.label}
                            </a>
                        ))}
                    ...
                    <div className="flex items-center gap-3">
                        {actions}
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-violet-500 p-[1px]">
