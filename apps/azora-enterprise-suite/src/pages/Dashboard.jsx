...
import { SignatureStamp } from '@azora/shared-design';
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-8">
                        ...
                        <GlassCard className="p-6">
                            <h3 className="text-lg font-bold text-white mb-2">🤝 Ubuntu Philosophy</h3>
                            <p className="text-sm text-slate-300 italic mb-2">
                                "Ngiyakwazi ngoba sikwazi"
                            </p>
                            <p className="text-sm text-slate-400">
                                Your enterprise success contributes to the collective prosperity of the Azora ecosystem.
                            </p>
                        </GlassCard>
                    </div>
                </div>
