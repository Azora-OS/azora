...
-- **Important** Do not use 'AzStudio', 'Azora', or any product term that might cause brand confusion in public API comments (this causes lint errors). Use neutral product-agnostic language when documenting API internals.
